...
sentinel_cfg = CitrusConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_citrusd_proto_version_with_sentinel_ping = 79999


def get_citrus_conf():
    home = os.environ.get('HOME')

    citrus_conf = os.path.join(home, ".citruscore/citrus.conf")
    if sys.platform == 'darwin':
        citrus_conf = os.path.join(home, "Library/Application Support/CitrusCore/citrus.conf")

    citrus_conf = sentinel_cfg.get('citrus_conf', citrus_conf)
